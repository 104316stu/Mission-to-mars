...
for (const movie in movieInfo) {
    ...
    newImg.alt = movieInfo[movie].title
...
function clickedMovie(movie) {
    ...
    if (movieInfo[movie]) {
        ...
        title.textContent = movieInfo[movie].title
        overview.textContent = movieInfo[movie].overview
        imdb.textContent = movieInfo[movie].imdb
        genre.textContent = movieInfo[movie].genre
        duration.textContent = movieInfo[movie].duration
        release.textContent = movieInfo[movie].release
        actors.textContent = movieInfo[movie].actors
        movieImage.src = movieInfo[movie].image
        movieImage.alt = movieInfo[movie].title
    } else {
